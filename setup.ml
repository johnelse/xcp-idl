...
(* OASIS_START *)
(* DO NOT EDIT (digest: 92f08dacc041c38393d7ec83ae51ce5c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Data_source"; "Ds"; "Rrdd_interface"; "Rrdd_client"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "rrdd";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\141\173\018\245\205n\153\163\228\2156\188$j\167w";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
